...
int main(int argc, char* argv[])
{
    ...
    string FolderPath =  "/home/yash/PLAG/CODE_PLAG/testcode/yyy/yash patil";   
	 
    string ResultPath =  "/home/yash/PLAG/CODE_PLAG/testcode/Result";
    ...
    string temp_sen = argv[1];
    int Minimum_Matching_length =stoi(temp_sen);
    cout<<"\n ***Measure of Software Plagiarism***" << endl << endl;
    try
    {
